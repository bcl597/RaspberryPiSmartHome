...
# topic (iot后台获取)
POST = '/sys/${YourProductKey}/${YourDeviceName}/thing/event/property/post'  # 上报消息到云
POST_REPLY = '/sys/${YourProductKey}/${YourDeviceName}/thing/event/property/post_reply'  
SET = '/sys/${YourProductKey}/${YourDeviceName}/thing/service/property/set'  # 订阅云端指令
